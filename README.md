...
- De [productie website](https://orthodox-ronl.github.io/koor/) wordt automatisch gebouwd wanneer naar de `main` branch wordt gepusht. 
- De [preview website](https://orthodox-ronl.github.io/koor/preview/) wordt automatisch gebouwd wanneer er een PR wordt afgesloten.
